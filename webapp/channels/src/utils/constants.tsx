...
defineMessages({
    ...
    socketError: {
        ...
        defaultMessage: 'Please check connection, Mattermost unreachable. If issue persists, ask administrator to [check WebSocket port](!https://guduu.co/).',
    },
...
export const AboutLinks = {
    TERMS_OF_SERVICE: 'https://guduu.co/',
    PRIVACY_POLICY: 'https://guduu.co/',
};

export const CloudLinks = {
    BILLING_DOCS: 'https://guduu.co/',
    PRICING: 'https://guduu.co/',
    PRORATED_PAYMENT: 'https://guduu.co/',
    DEPLOYMENT_OPTIONS: 'https://guduu.co/',
    DOWNLOAD_UPDATE: 'https://guduu.co/',
    CLOUD_SIGNUP_PAGE: 'https://guduu.co/',
    SELF_HOSTED_SIGNUP: 'https://guduu.co/',
    DELINQUENCY_DOCS: 'https://guduu.co/',
    SELF_HOSTED_PRICING: 'https://guduu.co/',
};

export const HostedCustomerLinks = {
    BILLING_DOCS: 'https://guduu.co/',
    SELF_HOSTED_BILLING: 'https://guduu.co/',
    TERMS_AND_CONDITIONS: 'https://guduu.co/',
    SECURITY_UPDATES: 'https://guduu.co/',
    DOWNLOAD: 'https://guduu.co/',
    NEWSLETTER_UNSUBSCRIBE_LINK: 'https://guduu.co/',
    PRIVACY: AboutLinks.PRIVACY_POLICY,
};

export const DocLinks = {
    ABOUT_TEAMS: 'https://guduu.co/',
    ADVANCED_LOGGING: 'https://guduu.co/',
    CONFIGURE_DOCUMENT_CONTENT_SEARCH: 'https://guduu.co/',
    CONFIGURE_AD_LDAP_QUERY_TIMEOUT: 'https://guduu.co/',
    CONFIGURE_OVERRIDE_SAML_BIND_DATA_WITH_LDAP: 'https://guduu.co/',
    COMPILANCE_EXPORT: 'https://guduu.co/',
    COMPILANCE_MONITORING: 'https://guduu.co/',
    DATA_RETENTION_POLICY: 'https://guduu.co/',
    DEFAULT_LDAP_GROUP_SYNC: 'https://guduu.co/',
    DESKTOP_MANAGED_RESOURCES: 'https://guduu.co/',
    ELASTICSEARCH: 'https://guduu.co/',
    ENABLE_HARDENED_MODE: 'https://guduu.co/',
    FORMAT_MESSAGES: 'https://guduu.co/',
    FILE_STORAGE: 'https://guduu.co/',
    GUEST_ACCOUNTS: 'https://guduu.co/',
    HIGH_AVAILABILITY_CLUSTER: 'https://guduu.co/',
    IN_PRODUCT_NOTICES: 'https://guduu.co/',
    MULTI_FACTOR_AUTH: 'https://guduu.co/',
    ONBOARD_ADVANCED_PERMISSIONS: 'https://guduu.co/',
    ONBOARD_LDAP: 'https://guduu.co/',
    SELF_HOSTED_BILLING: HostedCustomerLinks.SELF_HOSTED_BILLING,
    SESSION_LENGTHS: 'https://guduu.co/',
    SETUP_IMAGE_PROXY: 'https://guduu.co/',
    SETUP_LDAP: 'https://guduu.co/',
    SETUP_PERFORMANCE_MONITORING: 'https://guduu.co/',
    SETUP_PUSH_NOTIFICATIONS: 'https://guduu.co/',
    SETUP_SAML: 'https://guduu.co/',
    SHARE_LINKS_TO_MESSAGES: 'https://guduu.co/',
    SITE_URL: 'https://guduu.co/',
    SSL_CERTIFICATE: 'https://guduu.co/',
    TRUE_UP_REVIEW: 'https://guduu.co/',
    TRUSTED_CONNECTION: 'https://guduu.co/',
    UPGRADE_SERVER: 'https://guduu.co/',
};

export const DeveloperLinks = {
    CUSTOM_SLASH_COMMANDS: 'https://guduu.co/',
    ENABLE_OAUTH2: 'https://guduu.co/',
    INCOMING_WEBHOOKS: 'https://guduu.co/',
    OUTGOING_WEBHOOKS: 'https://guduu.co/',
    INTERACTIVE_MESSAGES: 'https://guduu.co/',
    INTERACTIVE_DIALOGS: 'https://guduu.co/',
    PERSONAL_ACCESS_TOKENS: 'https://guduu.co/',
    PLUGIN_SIGNING: 'https://guduu.co/',
    PLUGINS: 'https://guduu.co/',
    SETUP_CUSTOM_SLASH_COMMANDS: 'https://guduu.co/',
    SETUP_INCOMING_WEBHOOKS: 'https://guduu.co/',
    SETUP_OAUTH2: 'https://guduu.co/',
    SETUP_OUTGOING_WEBHOOKS: 'https://guduu.co/',
};

export const LicenseLinks = {
    CONTACT_SALES: 'https://guduu.co/',
    ENTRY_LIMITS_INFO: 'https://guduu.co/',
    TRIAL_INFO_LINK: 'https://guduu.co/',
    EMBARGOED_COUNTRIES: 'https://guduu.co/',
    SOFTWARE_SERVICES_LICENSE_AGREEMENT: 'https://guduu.co/',
    SOFTWARE_SERVICES_LICENSE_AGREEMENT_TEXT: 'Software Services and License Agreement',
    UNSUPPORTED: 'https://guduu.co/',
    UNSUPPORTED_UPGRADE_LINK: 'https://guduu.co/',
};

export const MattermostLink = 'https://guduu.co/';
...
export const Constants = {
    ...
    MHPNS_LEGACY_US: 'https://guduu.co/',
    MHPNS_LEGACY_DE: 'https://guduu.co/',
    MHPNS_GLOBAL: 'https://guduu.co/',
    MHPNS_US: 'https://guduu.co/',
    MHPNS_DE: 'https://guduu.co/',
    MHPNS_JP: 'https://guduu.co/',
    MTPNS: 'https://guduu.co/',
    MAX_PREV_MSGS: 100,
